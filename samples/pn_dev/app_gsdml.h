...
#define APP_GSDML_MOD_ID_IED                        0x00000050
...
/* Float tags for demo */
#define APP_GSDML_SUBMOD_ID_IEDSTATS_MIN            (0x0000014f)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_APPCOUNT       (0x00000150)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_MEMPCT         (0x00000151)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_APPPCT         (0x00000152)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_STORPCT        (0x00000153)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_MEM            (0x00000154)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_CPUPCT         (0x00000155)
#define APP_GSDML_SUBMOD_ID_IEDSTATS_MAX            (0x0000017f)
...
/* Demo properties */
#define APP_GSDML_INPUT_IEDSTATS_APPCOUNT_SIZE      (8) /* bytes */
#define APP_GSDML_OUTPUT_IEDSTATS_APPCOUNT_SIZE     APP_GSDML_INPUT_IEDSTATS_APPCOUNT_SIZE
#define APP_GSDML_INPUT_IEDSTATS_MEMPCT_SIZE        (8)
#define APP_GSDML_OUTPUT_IEDSTATS_MEMPCT_SIZE       APP_GSDML_INPUT_IEDSTATS_MEMPCT_SIZE 
#define APP_GSDML_INPUT_IEDSTATS_APPPCT_SIZE        (8)
#define APP_GSDML_OUTPUT_IEDSTATS_APPPCT_SIZE       APP_GSDML_INPUT_IEDSTATS_APPPCT_SIZE
#define APP_GSDML_INPUT_IEDSTATS_STORPCT_SIZE        (8)
#define APP_GSDML_OUTPUT_IEDSTATS_STORPCT_SIZE       APP_GSDML_INPUT_IEDSTATS_STORPCT_SIZE
#define APP_GSDML_INPUT_IEDSTATS_MEM_SIZE        (8)
#define APP_GSDML_OUTPUT_IEDSTATS_MEM_SIZE       APP_GSDML_INPUT_IEDSTATS_MEM_SIZE
#define APP_GSDML_INPUT_IEDSTATS_CPUPCT_SIZE        (8)
#define APP_GSDML_OUTPUT_IEDSTATS_CPUPCT_SIZE       APP_GSDML_INPUT_IEDSTATS_CPUPCT_SIZE
